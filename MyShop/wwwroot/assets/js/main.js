...
/*--
	Wishlist & Compare
------------------------*/
$('.wishlist-compare form a').on('click', function(e){
    e.preventDefault();
    //$(this).attr("disabled", true);
    if($(this).hasClass('added')){
       //$(this).removeClass('added');
        //$(this).append('<i class="ti-heart-broken"></i>');
    } else{
        $(this).addClass('added');
        //$(this).append('<i class="ti-heart"></i>');
    }
});
...
/*----- 
	Quantity
--------------------------------*/
$('.pro-qty').prepend('<input type="submit" class="dec qtybtn" value="-">');
$('.pro-qty').append('<input type="submit" class="inc qtybtn" value="+">');
